    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="sID" class="form-label">Stats ID</label>
          ...
          <div class="mb-3">
            <label for="sPA" class="form-label">Plate appearances</label>
            <input type="number" class="form-control" id="sPA" name="sPA">
          </div>
           <div class="mb-3">
            <label for="sAB" class="form-label">At-bats</label>
            <input type="text" class="form-control" id="sAB" name="sAB">
          </div> 
          <div class="mb-3">
            <label for="sOPS" class="form-label">OPS</label>
            <input type="text" class="form-control" id="sOPS" name="sOPS">
          </div> 
          <div class="mb-3">
            <label for="sEV" class="form-label">Average Exit Velocity</label>
