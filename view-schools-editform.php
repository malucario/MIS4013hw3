...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editSchoolModal<?php echo $school['SchoolRanking'];?>">
...
<!-- Modal -->
<div class="modal fade" id="editSchoolModal<?php echo $school['SchoolRanking'];?>" tabindex="-1" aria-labelledby="editSchoolModalLabel<?php echo $school['SchoolRanking'];?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editSchoolModalLabel<?php echo $school['SchoolRanking'];?>">Edit school</h1>
